...
namespace EcoClean.Controllers.Api
{
    ...
    public class AdminController : Controller
    {
      ...
      //  RoleManager<IdentityRole> _roleManager;
        ...
        [HttpPost]
        [Route("setEnterpriseRate/{enterpriseId?}")]
        public async void SetEnterpriseRate([FromRoute] int enterpriseId)
        {
            Enterprise enterprise = GetEnterpriseById(enterpriseId);
            ...
            // 10-point system
            double rate = 10 - Math.Abs(Math.Round((10 - (averageRatio * 10)), 2));
        ...
        {
            BackupDbTask backup = new BackupDbTask();
            backup.Execute();
        ...
        {
            RestoreDBTask restoredb = new RestoreDBTask();
            return restoredb.Execute();
        }
    }
}
